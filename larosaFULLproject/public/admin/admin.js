...
(() => {
  ...
  const switchView = (view) => {
    ...
    ({ dashboard: loadDashboard, orders: loadOrders, products: loadProducts, delivery: loadZones, settings: loadSettings })[view]?.();
  };
  ...
  function openEditor(id = null) {
    ...
    f.category.value = editing?.category || 'Bouquets';
